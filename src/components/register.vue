<template>
    <div class="login">
        ...
        <div class="form">
            ...
            <div class="active"><label>图形验证码</label><input class="captchaImage" type="text" placeholder="请输图形验证码" v-model="captchaImage"/><img class="Img" @click="refreshCaptcha" id="Img" src='http://120.24.160.251:8081/application/imgCode?+ Math.random()' /></div>
            <div>
                <label>短信验证码</label>
