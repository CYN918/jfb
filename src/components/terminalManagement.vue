				...
				<mt-tab-container-item id="1">
				    <div class="box">
						...
						<div class="list-news">
							...
							<p v-if="this.data != null">已选择{{this.checkModel.length}}台机具</p>
						</div>
						<div class="operation">
				...
				<mt-tab-container-item id="2">
					<div class="box">
						...
						<div class="list-news">
							...
							<div class="no-more" v-if="noMore">没有更多了~</div>
							<p v-if="this.data != null">已选择{{this.checkModel1.length}}台机具</p>
						</div>
						<div class="operation">
				...
				<mt-tab-container-item id="3">
					<div class="box">
						...
						<div class="list-news">
							...
							<div class="no-more" v-if="noMore">没有更多了~</div>
							<p v-if="this.data != null">已选择{{this.checkModel2.length}}台机具</p>
						</div>
						<div class="operation">
